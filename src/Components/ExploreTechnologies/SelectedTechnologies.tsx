    ...
    return (
        <div className="border border-gray-100 rounded-2xl py-4 px-6">
            <h2 className=" text-3xl font-medium">Your Stack</h2>
            {
                ...
                <>
                    <p className="text-xl text-gray-500 my-1 mb-6">No Technologies Selected Yet</p>
                    <p className="border border-dashed text-gray-500 text-center rounded-2xl my-2 py-5">Your Stack is empty</p>
